...
beforeEach(() => {
    ...
    window.Telegram = { WebApp: { ready: jest.fn(), expand: jest.fn(), initDataUnsafe: { user: { id: '12345678' } }, close: jest.fn(), sendData: jest.fn() } };
...
describe('openPlayer (via free card click)', () => {
    ...
    it('sets watermark with user id', async () => {
        ...
        expect(document.getElementById('watermarkId').textContent).toBe('12345678');
    });
});
